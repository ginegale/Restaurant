...
<head>
    ...
    <script>
        ...
        function loadTable() {
            $("#table").load("food_category_show_all_table.php", function (responseTxt, statusTxt, xhr) {
        ...
        function confirm_delete(id) {
            ...
            if (r == true) {
                ...
                //ajax
                $("#data").load("food_category_delete.php?id=" + id, function (responseTxt, statusTxt, xhr) {
